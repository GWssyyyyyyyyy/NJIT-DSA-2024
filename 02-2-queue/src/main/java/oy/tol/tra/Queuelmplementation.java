...
public class Queuelmplementation<E> implements QueueInterface<E> {
    ...
    public Queuelmplementation() throws QueueAllocationException{
        this(DEFAULT_QUEUE_SIZE);
    }



    public Queuelmplementation(int initialCapacity)throws QueueAllocationException {
    ...
    public E dequeue() throws QueuelsEmptyException {
        if (isEmpty()) {
            throw new QueuelsEmptyException("Queue is empty");
        }
